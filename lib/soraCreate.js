 ...
 * @param {number|string|null} [threadId] - Optional thread (feed) id to attach the video to
 * @returns {Promise<{ url?: string, error?: string }>} - { url } on success, { error } on failure
 */
export async function createSoraVideo(prompt, threadId = null) {
